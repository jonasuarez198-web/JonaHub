...
UIS.JumpRequest:Connect(function()
 if inf then lp.Character.Humanoid:ChangeState("Jumping") end
end)
...
inv.MouseButton1Click:Connect(function()
 invis=not invis
 inv.Text="Invisible: "..(invis and "ON" or "OFF")
  ...
  if plr~=lp and plr.Character then
   ...
   if hrp then
    if h then
     ...
     hrp.Color=Color3.fromRGB(170,170,170)
     hrp.CanCollide=false -- atravesás SOLO el cubo
    else
